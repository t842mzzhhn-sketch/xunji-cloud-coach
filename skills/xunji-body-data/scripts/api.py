...
OPERATIONS = {
    "body-query": ("https://api.xunjiapp.cn/open/body/query_gzip", "body", False),
    "body-upsert": ("https://api.xunjiapp.cn/open/body/upsert_gzip", "body", True),
}
ENV_NAMES = {"body": "XUNJI_BODY_API_KEY"}
...
def main() -> int:
    ...
    try:
        ...
        if mutating and payload.get("dry_run") is not True and payload.get("confirmed") is not True:
            raise ValueError("non-dry-run body mutation requires payload confirmed: true")
